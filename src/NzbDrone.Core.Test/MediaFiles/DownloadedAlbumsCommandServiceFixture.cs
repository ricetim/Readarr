...
namespace NzbDrone.Core.Test.MediaFiles
{
    ...
    public class DownloadedBooksCommandServiceFixture : FileSystemTest<DownloadedBooksCommandService>
    {
        ...
        public void should_process_folder_if_downloadclientid_is_not_specified()
        {
            ...
            Mocker.GetMock<IDownloadedBooksImportService>().Verify(c => c.ProcessPath(It.IsAny<string>(), ImportMode.Auto, null, null, null), Times.Once());
        }
        ...
        public void should_process_folder_with_downloadclientitem_if_available()
        {
            ...
            Mocker.GetMock<IDownloadedBooksImportService>().Verify(c => c.ProcessPath(_downloadFolder, ImportMode.Auto, _trackedDownload.RemoteBook.Author, _trackedDownload.DownloadItem, null), Times.Once());
        }
        ...
        public void should_process_folder_without_downloadclientitem_if_not_available()
        {
            ...
            Mocker.GetMock<IDownloadedBooksImportService>().Verify(c => c.ProcessPath(_downloadFolder, ImportMode.Auto, null, null, null), Times.Once());
        ...
        public void should_warn_if_neither_folder_or_file_exists()
        {
            ...
            Mocker.GetMock<IDownloadedBooksImportService>().Verify(c => c.ProcessPath(It.IsAny<string>(), ImportMode.Auto, null, null, null), Times.Never());
        ...
        public void should_override_import_mode()
        {
            ...
            Mocker.GetMock<IDownloadedBooksImportService>().Verify(c => c.ProcessPath(It.IsAny<string>(), ImportMode.Copy, null, null, null), Times.Once());
        }
    }
}
