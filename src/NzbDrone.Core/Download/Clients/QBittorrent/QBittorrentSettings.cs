...
namespace NzbDrone.Core.Download.Clients.QBittorrent
{
    ...
    public class QBittorrentSettings : IProviderConfig
    {
        ...
        [FieldDefinition(6, Label = "ApiKey", Type = FieldType.Password, Privacy = PrivacyLevel.ApiKey, Advanced = true, HelpText = "API key from qBittorrent 5.1+, used instead of a username and password.")]
