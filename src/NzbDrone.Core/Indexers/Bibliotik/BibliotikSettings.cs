...
namespace NzbDrone.Core.Indexers.Bibliotik
{
    ...
    public class BibliotikSettings : ITorrentIndexerSettings
    {
        ...
        [FieldDefinition(0, Label = "Session Cookie", Privacy = PrivacyLevel.ApiKey, HelpText = "Your Bibliotik session cookie. In Chrome/Edge: DevTools (F12) → Application → Cookies → https://bibliotik.me → copy the Value of the 'session' cookie. In Firefox: DevTools → Storage → Cookies → https://bibliotik.me → copy the Value of the 'session' cookie.")]
