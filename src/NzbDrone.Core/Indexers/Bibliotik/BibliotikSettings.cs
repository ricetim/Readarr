...
namespace NzbDrone.Core.Indexers.Bibliotik
{
    ...
    public class BibliotikSettings : ITorrentIndexerSettings
    {
        ...
        [FieldDefinition(0, Label = "Session Cookie", Privacy = PrivacyLevel.ApiKey, HelpText = "Your Bibliotik session cookie value. Open browser DevTools → Application → Cookies → bibliotik.me and copy the value of the 'session' cookie.")]
